...
const Portfolio: React.FC = () => {
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
            {/* Header */}
            <header className="max-w-4xl w-full rounded-lg p-4 flex flex-col md:flex-row items-center">
                <img
                    src={profile}
                    alt="Profile"
                    className="w-48 h-auto border-4 border-gray-300"
                />
                <div className="mt-6 md:mt-0 md:ml-6 text-center md:text-left">
                    ...
                    <p className="text-gray-600 mt-2 text-justify">
                        Saya memiliki pengalaman dalam mengembangkan aplikasi
                        web menggunakan teknologi front-end seperti Vue.js,
                        React, Tailwind, Flutter serta back-end dengan PHP dan
                        Express.js. Selain itu, saya sedang mempelajari
                        Typescript karena tertarik dengan Next.js.
                    </p>
                        ...
                        >
                            <div className="flex items-center space-x-2">
                                <img
                                    ...
                                    alt="link--v1"
                                />
                                <p>https://saktialfansyah.vercel.app</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            {/* Pengalaman Kerja */}
            <section className="max-w-4xl w-full rounded-lg mt-6 p-4">
            ...
            {/* Pendidikan */}
            <section className="max-w-4xl w-full rounded-lg mt-6 p-4 avoid-page-break">
            ...
            {/* Projek */}
            <section className="max-w-4xl w-full mt-6 p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 space-x-4">
                        <div>
                            ...
                            <p className="text-gray-500 text-justify">
                                Mengembangkan sistem berbasis web untuk
                                pengelolaan data pelanggan dan otomatisasi
                                pengingat tagihan. Fitur utama meliputi
                                pencatatan pelanggan, pelacakan jadwal
                                penagihan, serta pengiriman pengingat otomatis
                                melalui email dan Whatsapp untuk pembayaran yang
                                akan datang atau terlambat.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold">
                            ...
                            <p className="text-gray-500 text-justify">
                                Membangun frontend aplikasi presensi menggunakan
                                Flutter yang mengintegrasikan fitur kamera untuk
                                pengambilan foto saat absensi dan pelacakan
                                lokasi untuk memastikan kehadiran pengguna dalam
            ...
            {/* Portfolio */}
            <section className="max-w-4xl w-full mt-8 p-4">
