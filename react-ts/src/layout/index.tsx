...
const HomeLayout = () => {
    const fetchData = async () => {
        axios
            .get(
                "https://aluciodev.berkat-agung.com/inventory/inventory_list.code.php?action=list&whloc=G002&jtStartIndex=0&jtPageSize=100"
            )
            .then((response) => {
    ...
    const itemRenderer = (item: any) => (
        <Link className="flex align-items-center p-menuitem-link" to={""}>
    ...
    const end = (
        <div className="flex align-items-center gap-2">
            <InputText
                placeholder="Search"
                type="text"
                className="w-8rem border-0 rounded-md sm:w-auto"
            />
            <Avatar
                image="https://primefaces.org/cdn/primereact/images/avatar/amyelsner.png"
                shape="circle"
    ...
    return (
        <>
            <div className="flex flex-nowrap">
                <div className="bg-gray-800 shadow w-64 h-screen text-white flex-col justify-start hidden sm:flex">
                    <div className="px-8">
                        ...
                        <div className="mt-12">
                            <Link
                                to=""
                                className="flex w-full text-gray-300 justify-between cursor-pointer items-center"
                            >
                ...
                <div className="container mx-auto py-6 md:w-4/5 w-11/12 px-6">
                    ...
                    <div className="w-full h-full rounded border-dashed border-2 border-gray-300">
                        <Button label="Fetch" onClick={fetchData}></Button>
                    </div>
                </div>
            </div>
        </>
